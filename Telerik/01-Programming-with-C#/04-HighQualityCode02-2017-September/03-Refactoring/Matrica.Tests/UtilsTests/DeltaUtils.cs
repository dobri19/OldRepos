...
namespace Matrica.Tests.UtilsTests
{
    [TestFixture]
    public class DeltaUtils
    {
        ...
        {
            Assert.Throws<ArgumentException>(() => GameFifteen.Utils.DeltaUtils.GetDeltasByDirection(invalidDirection));
        }
        ...
        {
            var delta = GameFifteen.Utils.DeltaUtils.GetDeltasByDirection(validDirection);
